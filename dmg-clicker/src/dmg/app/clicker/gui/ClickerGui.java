...
import dmg.app.clicker.AutoClicker;
...
public class ClickerGui {
	...
	private void setupFrame() {
		...
		if (System.getProperty("os.name").toLowerCase().contains("mac")) {
			frame.setIconImage(
					new ImageIcon(AutoClicker.class.getClassLoader().getResource("assets/dmgmacro.png")).getImage());
		} else {
			frame.setIconImage(
					new ImageIcon(AutoClicker.class.getClassLoader().getResource("assets/dmgmacro.png")).getImage());
		}
